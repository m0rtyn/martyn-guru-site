  ...
  return function (t) {
    ...
    var i = "function" == typeof Symbol && "symbol" == _typeof(Symbol.iterator) ? function (t) {
      ...
      for (e = r.length - 1; e >= 0; e--) {
        (o = r[e]) && o.name && /^data-\w[\w\-]*$/.test(o.name) && (u = o.name.substr(5).replace(/-./g, c), n[u] = o.value);
      }
    ...
    var i = [],
      ...
      window.history.replaceState = function () {
        ...
        u = !1,
        c = {
      onUrlChange: function onUrlChange(t) {
        u || (o(), u = !0), i.push(t);
      }
    };
    ...
    e.a = {
      ...
      convertNumber: function convertNumber(t) {
    ...
    e.a = {
      ...
      counter: function counter(t, e, n) {
